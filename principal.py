...
volver=0.
week=0
lectura=readinputdata("CI_ESCALON_NUEVO.txt")
...
np.savetxt("vec_sus.txt", Vs,fmt='%1.4e') #vectores susceptibles
np.savetxt("huevos_secos.txt", H_SECOS,fmt='%1.4e') #huevos secos
np.savetxt("huevos_humedos.txt",H_HUM,fmt='%1.4e') #huevos humedos
#################################################################