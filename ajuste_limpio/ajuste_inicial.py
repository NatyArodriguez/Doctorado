...
fin = '2016-07-01' # Solo cambiar el año
final = 2016 #cambiar el año
...
def fun(parametros):
    ...
    BETA = [b7,b8,b9,b10,b11,b12,b13,b14,b15,b16]
    KMAX = [k7,k8,k9,k10,k11,k12,k13,k14,k15,k16]
    ...
    for t in range(1,dias):
        ...
        EV = sigma_V*v[7]
        H_t     = fn.h_t_1(Rain[int(t)], Tmean[int(t)], HR[int(t)])
        #print(v)
...
def objetive(trial):
    x = trial.suggest_float("x",2.0,3.5) #beta day
    y = trial.suggest_float("y", 600, 850) #kmax
    parametros = [x,y]
