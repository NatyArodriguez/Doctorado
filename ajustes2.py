...
def model(z,t):
    ...
    dDdt = thetaT0*(Vs + Ve + Vi) - mu_D*D - fR*D
    ...
    dHrdt = gama*Hi
    return np.array([dDdt,dWdt,dldt,dpdt,dmdt,dVsdt,dVedt,dVidt,dHsdt,dHedt,dHidt,dHrdt])
...
z0[6] = 0.
z0[7] = 0.
z0[8] = ALPHA*poblacion
z0[9] = 0.
z0[10] = 0.
z0[11] = poblacion - z0[8] - z0[9] - z0[10]
