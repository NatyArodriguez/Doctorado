...
b7 = b8 = b9 = 1.86#1.447#1.47
b10 = 0.77 #2.799#1.018
b11 = 0.05 #1.732#2.72
b12 = 2.318 #2.175#1.498
b13 = 2.157 #1.622#1.96
b14 = 1.127 #2.2339#1.39 #1.099
b15 = 0.018 #1.5868#2.15
b16 = 0.56 #2.721#1.74
b17 = b16

k7 = k8 = k9 = 96.60 #2678.696#231.52
k10 = 1147.85 #364.395#567.89
k11 = 53.43 #1206.935#1181.72
k12 = 260.63 #1924.660#17.915
k13 = 118.908 #1360.4268#1981.005
k14 = 2886.399 #2723.57788#183.61 #181.7356
k15 = 95.606 #2849.243#1681.09
k16 = 1437.978 #1531.4172#52.21
k17 = k16
...
################################ MODELO PARA LA ODE ###############################
def modelo(v,t, beta_day, Kmax):#,Tmean,Rain,HR,TMIN,beta_day,hogares,poblacion,Kmax,Hmax,MADURACION_MOSQUITO,bite_rate,MIObv,NO_INFECCION,MU_MOSQUITA_ADULTA,MATAR_VECTORES,MU_MOSQUITO_JOVEN,casosImp,G_T,EV):
...
for t in range(1,dias):
    ...
    solucion     =  rk4py2(modelo,t,h,v,args=(beta_day,Kmax))
    v = solucion
    #print(v[12])
    for q in range(13):
        if (v[q]< 0.):
