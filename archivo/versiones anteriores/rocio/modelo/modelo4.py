...
from semanas_epi2 import orden,orden_years, orden_years2, casos_anual
...
beta_day = 1.30      #1.12 // 1.27 // 1.68 // 1.16 // 2.07  #1.13 // 1.14 // 1.16 // 1.16 // 1.48 // 1.24 // 1.25      #2.05
Kmax = 795.829            #3555 // 1201 //529 // 970 // 363  #1685 // 1609 // 1499 // 1454 // 500 // 1000 // 999       #226 // 190
...
generados_anuales = [sum(orden_years(G_T,2009)),sum(orden_years(G_T,2010)),
                     sum(orden_years(G_T,2011)),sum(orden_years(G_T,2012)),
                     sum(orden_years(G_T,2013)),sum(orden_years(G_T,2014)),
                     sum(orden_years(G_T,2015)),sum(orden_years(G_T,2016))]
